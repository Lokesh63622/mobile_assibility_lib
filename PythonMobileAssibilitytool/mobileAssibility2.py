...
class ComprehensiveMobileAccessibilityScanner:
    def __init__(self, rules_config=None):
        ...
        self.default_rules = {
            ...
            "text-alternatives": {
                ...
                "why_it_matters": "Screen readers need text alternatives to describe images and other non-text content to visually impaired users.",
                "how_to_fix": "Add alt text to images, provide descriptions for icons, and ensure all visual content has text equivalents."
            },
            ...
            "info-relationships": {
                ...
                "why_it_matters": "Assistive technologies need to understand the structure and relationships between content elements.",
                "how_to_fix": "Use proper semantic HTML, ensure proper heading structure, and use ARIA labels when needed."
            },
            ...
            "color-not-only": {
                ...
                "why_it_matters": "Colorblind users may not perceive color differences and need additional cues.",
                "how_to_fix": "Add text labels, patterns, or icons alongside color coding."
            },
            ...
            "color-contrast": {
                ...
                "why_it_matters": "Low contrast text is difficult to read for users with low vision or in bright lighting conditions.",
                "how_to_fix": "Increase contrast ratio between text and background to at least 4.5:1 for normal text and 3:1 for large text.",
                "threshold": 4.5
            },
            ...
            "images-of-text": {
                ...
                "why_it_matters": "Images of text cannot be resized, have poor contrast when scaled, and are not accessible to screen readers.",
                "how_to_fix": "Use actual text with web fonts instead of images containing text."
            },
            ...
            "text-spacing": {
                ...
                "why_it_matters": "Users with low vision may need to adjust text spacing for better readability.",
                "how_to_fix": "Ensure CSS allows for text spacing adjustments without breaking layout."
            },
            ...
            "focus-order": {
                ...
                "why_it_matters": "Keyboard and screen reader users rely on logical focus order to understand and navigate content.",
                "how_to_fix": "Ensure tab order follows visual layout and reading order."
            },
            ...
            "link-purpose": {
                ...
                "why_it_matters": "Screen reader users often navigate by links and need to understand their purpose without surrounding context.",
                "how_to_fix": "Use descriptive link text that makes sense when read out of context."
            },
            ...
            "focus-visible": {
                ...
                "why_it_matters": "Keyboard users need to see which element currently has focus to navigate effectively.",
                "how_to_fix": "Ensure all focusable elements have visible focus indicators with sufficient contrast."
            },
            ...
            "pointer-gestures": {
                ...
                "why_it_matters": "Users with motor disabilities may not be able to perform complex gestures.",
                "how_to_fix": "Provide single-tap alternatives for complex gestures like pinch-to-zoom or swiping."
            },
            ...
            "label-in-name": {
                ...
                "why_it_matters": "Screen readers announce the accessible name, which should match what sighted users see.",
                "how_to_fix": "Ensure visible labels match programmatic labels and ARIA labels."
            },
            ...
            "touch-target-size": {
                ...
                "why_it_matters": "Small touch targets are difficult for users with motor disabilities or on mobile devices.",
                "how_to_fix": "Ensure interactive elements are at least 44x44 pixels in size.",
                "min_size": 44
            },
            ...
            "enhanced-target-size": {
                ...
                "why_it_matters": "Larger targets are easier to activate for users with motor impairments.",
                "how_to_fix": "Increase touch target size for important actions to at least 48x48 pixels.",
                "min_size": 48
            },
            ...
            "page-language": {
                ...
                "why_it_matters": "Screen readers need to know the language to pronounce content correctly.",
            ...
            "consistent-navigation": {
                ...
                "why_it_matters": "Consistency helps users learn and predict where to find navigation elements.",
                "how_to_fix": "Keep navigation in the same location and order across pages."
            },
            ...
            "error-suggestion": {
                ...
                "why_it_matters": "Users with cognitive disabilities may need help understanding and correcting errors.",
                "how_to_fix": "Provide specific, helpful error messages with suggestions for correction."
            },
            ...
            "name-role-value": {
                ...
                "why_it_matters": "Assistive technologies need to understand what each component is, what it does, and its current state.",
                "how_to_fix": "Use proper semantic HTML and ARIA attributes when necessary."
            },
            ...
            "mobile-touch-target": {
                ...
                "guideline": "M.1.1",
                "wcag_description": "Touch targets must be at least 44x44 pixels to accommodate finger touch accurately.",
                "why_it_matters": "Small touch targets cause errors and frustration, especially for users with motor impairments.",
                "how_to_fix": "Increase touch target size to minimum 44x44 pixels with adequate spacing.",
                "min_size": 44
            },
            ...
            "platform-conventions": {
                ...
                "guideline": "M.1.3",
                "wcag_description": "Follow platform-specific accessibility conventions and patterns that users are familiar with.",
                "why_it_matters": "Users expect consistent behavior based on their device platform.",
                "how_to_fix": "Use native UI components and follow platform design guidelines."
            },
            ...
            "touchscreen-navigation": {
                ...
                "guideline": "M.1.7",
                "wcag_description": "All functionality must be accessible via touchscreen gestures with appropriate alternatives.",
                "why_it_matters": "Mobile users rely primarily on touch interaction.",
                "how_to_fix": "Ensure all interactive elements work with touch and provide gesture alternatives."
            },
            ...
            "mobile-focus-management": {
                ...
                "guideline": "M.1.9",
                "wcag_description": "Focus must be managed appropriately when content changes or new content is added.",
                "why_it_matters": "Proper focus management prevents disorientation for screen reader users.",
                "how_to_fix": "Set focus to new content when it appears and maintain logical focus order."
            },
            ...
            "mobile-contrast": {
                ...
                "guideline": "M.2.5",
                "wcag_description": "Text and interactive elements must have sufficient contrast for mobile viewing in various lighting conditions.",
                "why_it_matters": "Mobile devices are often used outdoors or in bright lighting where contrast is crucial.",
                "how_to_fix": "Use higher contrast ratios for mobile interfaces (minimum 4.5:1).",
                "threshold": 4.5
            },
            ...
            "mobile-layout": {
                ...
                "guideline": "M.2.7",
                "wcag_description": "Layouts must adapt to different screen sizes and orientations while maintaining accessibility.",
                "why_it_matters": "Fixed layouts break accessibility on different screen sizes.",
                "how_to_fix": "Use responsive design techniques and test on various screen sizes."
            },
            ...
            "missing-labels": {
                ...
                "guideline": "1.3.1",
                "wcag_description": "All interactive elements must have accessible names that describe their purpose.",
                "why_it_matters": "Screen reader users cannot interact with elements that have no labels.",
                "how_to_fix": "Add visible text labels or content descriptions to all interactive elements."
            },
            ...
            "image-descriptions": {
                ...
                "guideline": "1.1.1",
                "wcag_description": "Images that convey meaning must have text alternatives that serve the same purpose.",
                "why_it_matters": "Visually impaired users need text descriptions to understand image content.",
                "how_to_fix": "Add alt text to informative images and mark decorative images as such."
            },
            ...
            "overlapping-elements": {
                ...
                "guideline": "2.5.1",
                "wcag_description": "Interactive elements must not overlap in ways that cause accidental activation.",
                "why_it_matters": "Overlapping elements cause accidental touches and navigation errors.",
                "how_to_fix": "Ensure adequate spacing between interactive elements."
            },
            ...
            "form-labels": {
                ...
                "guideline": "3.3.2",
                "wcag_description": "Labels or instructions are provided when content requires user input.",
                "why_it_matters": "Screen reader users need to know what information each form field requires.",
                "how_to_fix": "Associate visible labels with form inputs using for/id attributes."
            },
            ...
            "button-purpose": {
                ...
                "guideline": "2.4.4",
                "wcag_description": "The purpose of each button can be determined from its text or context.",
                "why_it_matters": "Users need to understand what will happen when they activate a button.",
                "how_to_fix": "Use descriptive button text that clearly indicates the action."
            }
        }
    ...
    # ---------------------------
    # ADB and Capture Methods (same as before)
    # ---------------------------
    ...
    # ---------------------------
    # Individual Rule Check Methods (same implementations as before)
    # ---------------------------
    ...
    # ... (include all the other check methods from the original code)
