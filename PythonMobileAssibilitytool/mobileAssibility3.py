        ...
        for priority in ["critical", "high", "medium", "low"]:
            ...
            for rule, group in grouped_issues.items():
                ...
                for i, instance in enumerate(group['instances']):
                    ...
                    html.append(f"<div class='instance-accordion'>")
                    html.append(f"<div class='instance-header'>")
                    html.append(f"<div class='instance-title'>")
                    html.append(f"<i class='instance-icon fas fa-bug'></i>")
                    ...
                    html.append("</div></div>")  # Close instance-content and instance-accordion
